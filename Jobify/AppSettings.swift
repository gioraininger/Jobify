...
class AppSettings {
    ...
    static func getMessages(userId: String) -> [Message] {
        ...
        case "kKex48cNMCTj5xxAA6GENO6NkWz1":
            messages.append(Message(senderId: "John Smith", recipientId: "Franco Manca", messageBody: "Hi guys, how are you doing? I am messaging you regarding your position at Costa Coffee as waiter. I was thinking to apply and cover your shift. Would I need to wear anyWe think you would be a good candidate to cover out position, please let us know if that would interest you. Thanks"))
            ...
            messages.append(Message(senderId: "John Smith", recipientId: "Franco Manca", messageBody: "Hi guys, how are you doing? I am messaging you regarding your position at Costa Coffeea as waiter. I was thinking to apply and cover your shift. Would I need to wear anyWe think you would be a good candidate to cover out position, please let us know if that would interest you. Thanks"))
